...
def update_interactive_elements_temporalization():
    ...
    df_temporalized=temporalis_functions.calculate_timeline(
        df_user=df_activities, 
        df_nodes=dataframe_for_temporalization,
        lca=chosen_lca
    )
...
def update_bokeh_pane(event):
    ...
    df_temporalized = update_interactive_elements_temporalization()
